...
export {default as Widget} from './HOC/Widget/Widget';
export {default as ClickableIcon} from './ClickableIcon/ClickableIcon';
...
export {default as UsersGroups} from './UsersGroups/UsersGroups';
